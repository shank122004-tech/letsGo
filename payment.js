...
(function () {
  ...
  window.renderPremiumModal = function () {
    ...
    <div id="upgPersonalPlans" class="upg-plans-grid">
      ...
      <div class="upg-card ${(isPrem && (curPlan==='ssc'||curPlan==='premium')) ? 'upg-card-active' : ''}">
        ...
        <div class="upg-card-tagline">Unlimited Professional AI chats + Mock Tests + Battle access</div>
        ...
        <ul class="upg-features">
          <li>✦ Unlimited Professional AI chats </li>
      ...
      <div class="upg-card ${(isPrem && curPlan==='yearly') ? 'upg-card-active' : ''}">
        ...
        <div class="upg-price-row">
          <div>
            ...
            <div style="display:flex;align-items:baseline;gap:4px;">
              <span class="upg-price">₹1,699</span>
  ...
  function injectPremiumModalStyles() {
    ...
    s.textContent = `
      ...
      .upg-card-tagline { font-size:11px; color:var(--text-secondary); margin-bottom:14px; line-height:1.4; }
      ...
      .upg-price-per { display:block; font-size:11px; color:var(--text-secondary); margin-top:3px; }
      .upg-price-old { font-size:12px; color:var(--text-muted); text-decoration:line-through; margin-bottom:2px; }
      .upg-save-pill {
      ...
      .upg-btn-active  { background:rgba(255,255,255,0.08); color:var(--text-secondary); cursor:default; font-weight:600; }
  ...
  function injectCompanionGateStyles() {
    ...
    s.textContent = `
      ...
      .cgm-plan-tab{flex:1;padding:8px 4px;border-radius:10px;border:1px solid rgba(255,255,255,0.1);background:transparent;color:var(--text-secondary);font-size:12px;font-weight:600;cursor:pointer;transition:all .2s;position:relative;}
